...
import lars.view.event.{Editwindow => Event}
...
/**
@emits subtype of lars.view.event.Editwindow
...
abstract class Editwindow
  ...
  */
  ...
  private def create_select_primary(): TabSheet = {
    ...
    select_primary.addTab(create_panel_edit, "Auswahl Bearbeiten", null)
    select_primary.addTab(create_panel_new, "Neu anlegen", null)
    //create_panel_delete
    select_primary.addTab(create_panel_delete, "Löschen", null)
  ...
  private def create_select_secondary = {
    ...
    select_secondary.addTab(create_panel_table, "Alles", null)
    select_secondary.addTab(create_panel_table_history, "Historie der Auswahl", null)
